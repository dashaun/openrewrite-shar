...
SHAR_URL="https://tanzu.vmware.com/spring-health-assessment"
REPO_URL="https://github.com/dashaun/hello-spring-boot-2-6.git"
...
function cloneApp {
  ...
  pei "git clone $REPO_URL ./"
}

# Create a simple Spring Boot application
function dependencyTree {
  displayMessage "Generate the spring-dependencies.txt file"
  pei "./mvnw dependency:tree | grep -E '(org.springframework|io.micrometer)' > spring-dependencies.txt"
  pei "cat spring-dependencies.txt"
  pei "open $PWD"
}
